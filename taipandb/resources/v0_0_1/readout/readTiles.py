...
import taipandb.resources.v0_0_1.readout.readScience as rS
import taipandb.resources.v0_0_1.readout.readGuides as rG
import taipandb.resources.v0_0_1.readout.readStandards as rSt
...
def execute(cursor, tile_pks=None, field_ids=None,
    ...
    if standard_targets is None:
        ...
        standard_targets = rSt.execute(cursor,
                                       field_list=
                                       list(set(fibreassigns['field_id'])))
